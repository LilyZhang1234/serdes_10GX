module serdesblock_altera_lvds_core20_191_tm4jgua #(
   ...
   input  logic [127:0]    tx_in,
   output logic [15:0]     tx_out,
   output logic            tx_outclock,
   output logic            tx_coreclock,
   input  logic [15:0]     rx_in,
   output logic [127:0]    rx_out,
   input  logic [15:0]     rx_bitslip_reset,
   input  logic [15:0]     rx_bitslip_ctrl,
   output logic [15:0]     rx_bitslip_max,
   ...
   output logic [15:0]     rx_dpa_locked,
   input  logic [15:0]     rx_dpa_hold,
   input  logic [15:0]     rx_dpa_reset,
   input  logic [15:0]     rx_fifo_reset,
   output logic [15:0]     rx_divfwdclk,
   input  logic [15:0]     loopback_in,
   output logic [15:0]     loopback_out,
