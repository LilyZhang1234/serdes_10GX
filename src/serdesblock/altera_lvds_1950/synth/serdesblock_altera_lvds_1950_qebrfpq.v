// serdesblock_altera_lvds_1950_qebrfpq.v
...
`timescale 1 ps / 1 ps
module serdesblock_altera_lvds_1950_qebrfpq (
	...
	serdesblock_altera_lvds_core20_191_tm4jgua #(
		.NUM_CHANNELS                       (16),
		.J_FACTOR                           (8),
		...
		.pll_input_clock_frequency          ("160.0 MHz"),
		.pll_vco_clock_frequency            ("1280.0 MHz"),
		.m_cnt_hi_div                       (4),
		.m_cnt_lo_div                       (4),
		.n_cnt_hi_div                       (256),
		.n_cnt_lo_div                       (256),
		...
		.pll_output_clock_frequency_0       ("1280.0 MHz"),
		.pll_output_phase_shift_0           ("390 ps"),
		.pll_output_duty_cycle_0            (50),
		.pll_output_clock_frequency_1       ("160.0 MHz"),
		.pll_output_phase_shift_1           ("5468 ps"),
		.pll_output_duty_cycle_1            (13),
		.pll_output_clock_frequency_2       ("160.0 MHz"),
		...
		.tx_in                   (tx_in),                //   input,  width = 128,        tx_in_conduit_end.export
		.tx_out                  (tx_out),               //  output,   width = 16,       tx_out_conduit_end.export
		.tx_coreclock            (tx_coreclock),         //  output,    width = 1, tx_coreclock_conduit_end.export
		.inclock                 (tx_inclock),           //   input,    width = 1,      inclock_conduit_end.export
		.pll_areset              (pll_areset),           //   input,    width = 1,   pll_areset_conduit_end.export
		.pll_locked              (tx_locked),            //  output,    width = 1,   pll_locked_conduit_end.export
		.tx_outclock             (),                     // (terminated),                                        
		.rx_in                   (16'b0000000000000000), // (terminated),                                        
		.rx_out                  (),                     // (terminated),                                        
		.rx_bitslip_reset        (16'b0000000000000000), // (terminated),                                        
		.rx_bitslip_ctrl         (16'b0000000000000000), // (terminated),                                        
		...
		.rx_dpa_hold             (16'b0000000000000000), // (terminated),                                        
		.rx_dpa_reset            (16'b0000000000000000), // (terminated),                                        
		.rx_fifo_reset           (16'b0000000000000000), // (terminated),                                        
		.rx_divfwdclk            (),                     // (terminated),                                        
		.loopback_in             (16'b0000000000000000), // (terminated),                                        
