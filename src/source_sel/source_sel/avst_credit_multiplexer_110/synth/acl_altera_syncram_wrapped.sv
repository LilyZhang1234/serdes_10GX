...
(
  ...
  localparam int MEMORY_WIDTH_A   =  width_a; // width of codewords coming out of the encoder at port a
  localparam int MEMORY_WIDTH_B   =  width_b; // width of codewords coming out of the encoder at port b
