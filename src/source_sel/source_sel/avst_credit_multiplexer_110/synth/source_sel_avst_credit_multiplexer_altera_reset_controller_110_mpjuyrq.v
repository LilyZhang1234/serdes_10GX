// source_sel_avst_credit_multiplexer_altera_reset_controller_110_mpjuyrq.v

// Generated using ACDS version 21.1 169

`timescale 1 ps / 1 ps
module source_sel_avst_credit_multiplexer_altera_reset_controller_110_mpjuyrq #(
		...
		input  wire  reset_in2, // reset_in2.reset
		input  wire  reset_in3, // reset_in3.reset
		input  wire  reset_in4, // reset_in4.reset
		input  wire  reset_in5, // reset_in5.reset
	...
	) my_altera_reset_controller (
		.reset_in0      (reset_in0), //   input,  width = 1, reset_in0.reset
		.reset_in1      (reset_in1), //   input,  width = 1, reset_in1.reset
		.reset_in2      (reset_in2), //   input,  width = 1, reset_in2.reset
		.reset_in3      (reset_in3), //   input,  width = 1, reset_in3.reset
		.reset_in4      (reset_in4), //   input,  width = 1, reset_in4.reset
		.reset_in5      (reset_in5), //   input,  width = 1, reset_in5.reset
